    ...
    <div className="header w-full flex justify-between p-2 px-0 fixed top-0 left-0 bg-white">
      ...
      <div className="searchbar w-5/12 md:w-6/12 flex justify-center items-center">
        <div className="search w-11/12 flex justify-end  overflow-hidden">
          ...
          <div className="searchicon w-16 text-center order-3" onClick={mobilesearchhandle}>
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
     ...
     {mobilesearch? <div className="searchbarforphone w-full flex justify-center items-center bg-white absolute top-0 left-0 sm:hidden p-2">
        <div className="searche w-full flex justify-end items-center overflow-hidden rounded-lg border border-gray-400">
          <input
          ...
          <div className="searchicone  w-16 text-center order-3 "  onClick={mobilesearchhandle}>
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
              class="style-scope yt-icon w-6 h-6 m-auto mt-2 "
            >
              <g class="style-scope yt-icon">
                <path
                  d="M20.87,20.17l-5.59-5.59C16.35,13.35,17,11.75,17,10c0-3.87-3.13-7-7-7s-7,3.13-7,7s3.13,7,7,7c1.75,0,3.35-0.65,4.58-1.71 l5.59,5.59L20.87,20.17z M10,16c-3.31,0-6-2.69-6-6s2.69-6,6-6s6,2.69,6,6S13.31,16,10,16z"
